    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                foreach (char signo in cadaSigno)
                {
                       ...
                       
                    {
                        if (signo == 'X')
                        {
                            Console.WriteLine("************************************");
                            Console.Write("* ");
                            Console.WriteLine($"Felicidades!! Ha ganado el jugador {jugador}*");
                            Console.WriteLine("************************************");
                        }
                        else
                        {
                            ...
                            Console.WriteLine("Presione cualquier tecla para reinicia el juego");
                            Console.Read();
                            Resetear();
                            ingreso = 0;
                            break;
                ...
                #endregion
                // Código que verifica si el valor ingresado es valido
                #region
                do
                {
        ...
        // Array que contiene variable del juego
